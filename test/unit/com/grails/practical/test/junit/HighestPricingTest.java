...
public class HighestPricingTest {
	...
	public void testForInstantiation(){
		org.junit.Assert.assertTrue((priceCalculation.getClass().equals(HighestPricingStrategy.class)) == true);
	}
	
	@Test
	public void testHighestPriceCalculationStrategy() {
		BigDecimal price1 = new BigDecimal(60.00);
		
		BigDecimal price2 = new BigDecimal("60.00");
		
		BigDecimal price3 = new BigDecimal(60.0);
